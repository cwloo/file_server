...
var file_monitor_monitor_proto_rawDesc = []byte{
	...
	0x22, 0x21, 0x0a, 0x0d, 0x46, 0x69, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x65,
	0x71, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x64, 0x35, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	0x6d, 0x64, 0x35, 0x22, 0x66, 0x0a, 0x0e, 0x46, 0x69, 0x6c, 0x65, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x64, 0x35, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x6d, 0x64, 0x35, 0x12, 0x10, 0x0a, 0x03, 0x64, 0x6e, 0x73, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x64, 0x6e, 0x73, 0x12, 0x18, 0x0a, 0x07, 0x65, 0x72, 0x72,
	...
	,
...
var file_monitor_monitor_proto_goTypes = []interface{}{
	(*FileServerReq)(nil),  // 0: monitor.FileServerReq
	(*FileServerResp)(nil), // 1: monitor.FileServerResp
}
var file_monitor_monitor_proto_depIdxs = []int32{
	0, // 0: monitor.monitor.GetFileServer:input_type -> monitor.FileServerReq
	1, // 1: monitor.monitor.GetFileServer:output_type -> monitor.FileServerResp
...
func (c *monitorClient) GetFileServer(ctx context.Context, in *FileServerReq, opts ...grpc.CallOption) (*FileServerResp, error) {
	out := new(FileServerResp)
	err := c.cc.Invoke(ctx, "/monitor.monitor/GetFileServer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedMonitorServer) GetFileServer(context.Context, *FileServerReq) (*FileServerResp, error) {
...
func _Monitor_GetFileServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FileServerReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MonitorServer).GetFileServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/monitor.monitor/GetFileServer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MonitorServer).GetFileServer(ctx, req.(*FileServerReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Monitor_GetFileServer_Handler,
		},
	},
